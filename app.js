...
const NotifyModal = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-16 h-16 mx-auto rounded-full bg-blue-50 text-blue-500 flex items-center justify-center mb-4"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "mail-check",
    className: "w-8 h-8"
...
const App = () => {
  ...
  const institutions = [{
    ...
    specs: {
      recruitSchedule: '연 2회 (상반기 3~4월, 하반기 8~9월)',
      seasonMonths: [3, 4, 8, 9],
    ...
    specs: {
      recruitSchedule: '연 2회 (상반기 4~5월, 하반기 9~10월)',
    ...
    specs: {
      recruitSchedule: '연 2회 (상반기 4월, 하반기 9월)',
      seasonMonths: [4, 9],
    ...
    specs: {
      recruitSchedule: '수시 및 상·하반기 통합 채용',
      seasonMonths: [],
    ...
    specs: {
      recruitSchedule: '상·하반기 및 결원 수시 채용',
      seasonMonths: [],
    ...
    specs: {
      recruitSchedule: '본사 통합 및 각 지사별 수시',
      seasonMonths: [],
    ...
    specs: {
      recruitSchedule: '수시 채용 (공무직·임기제 중심)',
      seasonMonths: [],
    ...
    specs: {
      recruitSchedule: '수시 채용 (직무별 개별 공고)',
      seasonMonths: [],
    ...
    specs: {
      recruitSchedule: '결원 발생 시 수시 (통합 공고 내 직무별 선발)',
      seasonMonths: [],
  ...
  useEffect(() => {
    ...
    fetch('history.json?t=' + Date.now()).then(r => r.ok ? r.json() : {
      jobs: []
    }).then(data => {
      const counts = {};
      (data.jobs || []).forEach(j => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "bg-blue-600 text-white px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider flex items-center gap-1"
  }, /*#__PURE__*/React.createElement("span", {
    className: "w-1.5 h-1.5 rounded-full bg-white animate-pulse"
  }), " 1시간 주기 자동 업데이트"), /*#__PURE__*/React.createElement("span", {
    className: "bg-white border border-slate-200 text-slate-600 px-2.5 py-0.5 rounded-full text-[10px] font-bold shadow-sm flex items-center gap-1"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "calendar",
    className: "w-3 h-3 text-blue-500"
  }), " 기준일자: ", formatDate(lastSync)), /*#__PURE__*/React.createElement("span", {
    className: "bg-white border border-slate-200 text-slate-500 px-2.5 py-0.5 rounded-full text-[10px] font-bold shadow-sm flex items-center gap-1"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "clock",
    className: "w-3 h-3"
    ...
    name: "plus-circle",
    className: "w-3 h-3"
  }), " 기관 추가 요청"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowNotify(true),
    className: "bg-blue-600 text-white px-2.5 py-0.5 rounded-full text-[10px] font-bold shadow-sm flex items-center gap-1 hover:bg-blue-700 transition-colors"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "bell",
    className: "w-3 h-3"
  ...
  }, "국민건강보험공단·건강보험심사평가원·국민연금공단·근로복지공단 등 12개 기관의 공공기관 채용 공고를 1시간마다 자동으로 모아 보여드립니다. 보건관리자·보건직·행정직 공고와 기관별 전형 절차·근무환경 정보까지 한곳에서 확인하세요."))), mainView === 'jobs' ? /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-[11px] font-black text-slate-400 uppercase mb-4 tracking-widest flex items-center gap-1"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "link",
    className: "w-3 h-3"
  }), " 기관별 채용 사이트"), /*#__PURE__*/React.createElement("nav", {
    className: "space-y-3"
  }, institutions.map(inst => /*#__PURE__*/React.createElement("div", {
    key: inst.id,
    className: "pb-3 border-b border-slate-50 last:border-0 last:pb-0"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-[13px] font-bold text-slate-700"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => window.open(inst.url, '_blank'),
    className: "hover:text-blue-600 transition-colors flex items-center gap-1.5 text-left"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "building-2",
    ...
    }), " ", job.region || "전국")), /*#__PURE__*/React.createElement("h3", {
      className: `text-[16px] md:text-[17px] font-bold text-slate-800 mb-2 leading-snug break-keep`
  ...
  }, "필터 전체 초기화"))), /*#__PURE__*/React.createElement("section", {
    className: "bg-white p-5 md:p-7 rounded-2xl border border-slate-200 shadow-sm text-left space-y-6"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    className: "text-[15px] font-black text-slate-900 flex items-center gap-2"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "calendar-days",
    className: "w-4 h-4 text-blue-600"
  }), " 기관별 채용 시즌"), /*#__PURE__*/React.createElement("p", {
    className: "text-[12px] text-slate-400 font-medium mt-1"
  }, "지금 공고가 적다면 비수기일 수 있습니다. 주요 기관의 공채는 ", /*#__PURE__*/React.createElement("strong", {
    className: "text-slate-500"
  }, "상반기 3~5월"), ", ", /*#__PURE__*/React.createElement("strong", {
    className: "text-slate-500"
  }, "하반기 8~10월"), "에 몰립니다.")), seasonNow.length > 0 ? /*#__PURE__*/React.createElement("div", {
    className: "bg-blue-50 border border-blue-100 rounded-xl p-4"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-[12.5px] font-bold text-blue-900 leading-relaxed"
  }, "📌 ", currentMonth, "월은 ", /*#__PURE__*/React.createElement("strong", null, seasonNow.map(i => i.shortName).join(' · ')), " 공채가 집중되는 시기입니다. 공고가 아직 안 보인다면 곧 올라올 수 있으니 다시 확인해 주세요.")) : nextSeason && /*#__PURE__*/React.createElement("div", {
    className: "bg-amber-50 border border-amber-100 rounded-xl p-4"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-[12.5px] font-bold text-amber-900 leading-relaxed"
  }, "🌙 ", currentMonth, "월은 정기 공채 비수기입니다. 다음 공채 시즌은 ", /*#__PURE__*/React.createElement("strong", null, nextSeason.month, "월"), "이며, ", /*#__PURE__*/React.createElement("strong", null, nextSeason.list.map(i => i.shortName).join(' · ')), " 채용이 시작됩니다. 그때까지도 수시 채용 공고는 계속 올라옵니다.")), /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      href: 'inst-' + inst.id + '.html',
      className: `text-[13px] font-bold hover:underline ${inSeason ? 'text-blue-700' : 'text-slate-700'}`
    }, inSeason && '🔵 ', inst.shortName), /*#__PURE__*/React.createElement("p", {
      className: "text-[11px] text-slate-400 font-medium truncate"
    }, inst.specs.recruitSchedule)), /*#__PURE__*/React.createElement("a", {
      href: 'inst-' + inst.id + '.html',
      className: "shrink-0 text-[11px] font-bold text-slate-500 bg-slate-100 hover:bg-blue-100 hover:text-blue-700 px-2.5 py-1 rounded-full transition-colors"
    }, n > 0 ? `지난 공고 ${n}건` : '기관 정보'));
  })), totalArchive > 0 && /*#__PURE__*/React.createElement("p", {
    className: "text-[12px] text-slate-500 font-medium bg-slate-50 border border-slate-200 rounded-xl p-4 leading-relaxed"
  }, "📁 지금까지 수집한 공고 ", /*#__PURE__*/React.createElement("strong", {
    className: "text-slate-800"
  }, totalArchive, "건"), "을 기관별 상세 페이지에 보관하고 있습니다. 마감된 공고도 남아 있어, 그 기관이 ", /*#__PURE__*/React.createElement("strong", {
    className: "text-slate-800"
  }, "어떤 직무를 어떤 고용형태로 뽑아 왔는지"), " 확인할 수 있습니다.")))) : /*#__PURE__*/React.createElement("div", {
    className: "bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-16 text-left"
  }, /*#__PURE__*/React.createElement("header", {
    className: "border-b border-slate-100 pb-8"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-black text-slate-900 mb-4"
  }, "보건의료 공공기관별 전형 절차·필기 과목 분석"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-500 font-medium leading-relaxed"
  }, "이 페이지는 ", /*#__PURE__*/React.createElement("strong", {
    className: "text-slate-700"
  }, "\"어떻게 들어가는가\""), "만 다룹니다. 기관별 전형 단계, 필기 시험 구성, 서류 요건과 가점 항목을 정리했습니다."), /*#__PURE__*/React.createElement("div", {
    className: "mt-5 bg-slate-50 border border-slate-200 rounded-2xl p-5 text-[13px] text-slate-600 font-medium leading-relaxed space-y-1.5"
  }, /*#__PURE__*/React.createElement("p", {
    className: "font-bold text-slate-800 mb-2"
  }, "📚 다른 페이지와의 역할 구분"), /*#__PURE__*/React.createElement("p", null, "· ", /*#__PURE__*/React.createElement("a", {
    href: "guide.html",
    className: "text-blue-600 font-bold hover:underline"
  }, "기관별 근무환경·워라밸"), " — 본사 위치, 순환근무, 업무강도, 조직문화, ", /*#__PURE__*/React.createElement("strong", null, "신입 초임(ALIO 공시 기준)"), " 등 ", /*#__PURE__*/React.createElement("strong", null, "입사 이후의 삶")), /*#__PURE__*/React.createElement("p", null, "· ", /*#__PURE__*/React.createElement("strong", null, "기관별 상세 페이지"), " — 기관별 누적 공고 아카이브와 고용형태·근무지역 수집 통계 (각 기관 카드 하단 링크)")), /*#__PURE__*/React.createElement("p", {
    className: "text-[12px] text-slate-400 font-medium mt-4"
  }, "※ 전형 절차와 필기 과목은 채용 연도·직렬·고용형태에 따라 달라집니다. 아래 내용은 최근 공고를 기준으로 한 일반적인 경향이며, 지원 전 반드시 해당 공고 원문을 확인하세요.")), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 gap-12"
  }, institutions.map(inst => /*#__PURE__*/React.createElement("article", {
    key: inst.id,
    className: "space-y-5"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-xl font-bold text-blue-700 flex items-center gap-2 underline underline-offset-8 decoration-blue-100"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "building"
  }), " ", inst.name, " (", inst.shortName, ")"), /*#__PURE__*/React.createElement("div", {
    className: "text-[14px] text-slate-700 space-y-3 font-medium leading-relaxed"
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "📅 채용 주기:"), " ", inst.specs.recruitSchedule), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "🪜 전형 단계:"), " ", inst.specs.stages), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "✍️ 필기·직무 평가:"), " ", inst.specs.written), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "📄 서류 요건·가점:"), " ", inst.specs.docs), /*#__PURE__*/React.createElement("div", {
    className: "bg-blue-50 p-6 rounded-2xl text-blue-900 text-[13.5px] border border-blue-100 mt-2 shadow-inner leading-relaxed"
  }, /*#__PURE__*/React.createElement("strong", null, "💡 준비 포인트:"), " ", inst.specs.point), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-2 pt-1"
  }, /*#__PURE__*/React.createElement("a", {
    href: 'inst-' + inst.id + '.html',
    className: "text-[12px] font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded-full transition"
  }, "📋 공고 아카이브·수집 통계"), /*#__PURE__*/React.createElement("a", {
    href: "guide.html",
    className: "text-[12px] font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded-full transition"
  }, "🏢 근무환경·초임 보기"), /*#__PURE__*/React.createElement("a", {
    href: inst.url,
    target: "_blank",
    rel: "noopener noreferrer",
    className: "text-[12px] font-bold text-blue-700 bg-blue-50 hover:bg-blue-100 px-3 py-1.5 rounded-full transition"
  }, "🔗 공식 채용 페이지"))))))), /*#__PURE__*/React.createElement("section", {
    className: "mt-20 bg-white p-6 md:p-9 rounded-3xl border border-slate-200 shadow-sm text-left"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-xl font-black text-slate-900 mb-1.5 flex items-center gap-2"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "help-circle",
    className: "text-blue-600"
  }), " 보건의료 취업 자주 묻는 질문 (FAQ)"), /*#__PURE__*/React.createElement("p", {
    className: "text-[12px] text-slate-400 font-medium mb-6"
  }, "탈임상·보건직 공기업 준비생들이 가장 많이 묻는 질문을 모았습니다."), /*#__PURE__*/React.createElement("div", {
    ...
    q: "공고는 얼마나 자주 갱신되나요?",
    a: "본 사이트는 각 기관 채용 페이지를 1시간마다 자동 수집하여 진행 중인 공고만 보여드립니다. 마감되었거나 접수 기한이 지난 공고는 자동으로 숨겨집니다. 다만 정확한 자격 요건과 일정은 반드시 각 기관 공식 공고문을 확인하세요."
  }, {
    q: "원하는 기관이 목록에 없어요. 추가할 수 있나요?",
    a: "상단 '기관 추가 요청' 버튼이나 하단 '문의하기'를 통해 기관명과 채용 페이지 주소를 남겨주시면, 검토 후 수집 대상에 반영합니다."
  }].map((f, i) => /*#__PURE__*/React.createElement("details", {
    key: i,
    className: "group py-4"
  }, /*#__PURE__*/React.createElement("summary", {
    className: "flex items-start gap-2 cursor-pointer list-none font-bold text-slate-900 text-[14.5px] leading-snug break-keep"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    name: "chevron-down",
    className: "w-4 h-4 text-slate-400 mt-0.5 shrink-0 transition-transform group-open:rotate-180"
  })), /*#__PURE__*/React.createElement("p", {
    className: "mt-3 pl-5 text-[13.5px] text-slate-600 font-medium leading-relaxed break-keep"
  }, f.a))))), /*#__PURE__*/React.createElement("footer", {
    ...
    className: "fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 flex flex-col items-end animate-in fade-in duration-500"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-slate-800 text-white text-[11px] font-bold px-3.5 py-2 rounded-xl shadow-lg mb-3 relative animate-bounce"
  }, "※ 구글 로그인이 필요해요!", /*#__PURE__*/React.createElement("div", {
    className: "absolute -bottom-1.5 right-6 w-3 h-3 bg-slate-800 rotate-45"
  })), /*#__PURE__*/React.createElement("button", {
  ...
  }, "탈임상 AI 챗봇"), /*#__PURE__*/React.createElement("span", {
    className: "md:hidden"
  }, "AI 챗봇"))), showContact && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    name: "mail",
    className: "w-14 h-14 mx-auto text-blue-500 mb-4"
  }), /*#__PURE__*/React.createElement("h2", {
  ...
  }), /*#__PURE__*/React.createElement(NotifyModal, {
    open: showNotify,
