...
const App = () => {
    ...
    const institutions = [
        ...
        { id: 'kuksiwon', name: '한국보건의료인국가시험원', shortName: '국시원', url: 'https://recruit.incruit.com/kuksiwon', specs: {
    ...
    return (
        <div className="max-w-5xl mx-auto p-4 md:p-8 flex flex-col min-h-[100dvh]">
            ...
            <div className="site-nav-wrap mb-10 -mx-4 md:mx-0 border-b border-slate-200 pb-2">
            <nav ref={navRef} className="site-nav px-4 md:px-0 text-[12.5px] md:text-[13px]">
                <button onClick={() => { setMainView('jobs'); if (history.replaceState) history.replaceState(null, '', location.pathname); }} className={`site-nav-link ${mainView === 'jobs' ? 'is-active' : ''}`}>홈</button>
                <button onClick={() => { setMainView('guide'); if (history.replaceState) history.replaceState(null, '', '#guide'); }} className={`site-nav-link ${mainView === 'guide' ? 'is-active' : ''}`}>기관별 합격 가이드</button>
                <a href="guide.html" className="site-nav-link">근무환경·워라밸</a>
                <a href="gongmujik.html" className="site-nav-link">공무직·무기계약직</a>
                <a href="bogeon-manager.html" className="site-nav-link">보건관리자</a>
                <a href="ganhojik.html" className="site-nav-link">간호직 공무원</a>
                <a href="tips.html" className="site-nav-link">채용 트렌드</a>
                <a href="career.html" className="site-nav-link">임상경력 활용</a>
                <a href="license.html" className="site-nav-link">서류 가점 전략</a>
                <a href="interview.html" className="site-nav-link">면접 필승 가이드</a>
            </nav>
            </div>
